...
SELECT pg_catalog.setval('facebookcredential_id_seq', 2, true);
...
SELECT pg_catalog.setval('logincredential_id_seq', 10, true);
...
SELECT pg_catalog.setval('session_id_seq', 29, true);
